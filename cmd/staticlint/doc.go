/*
Multichecker with several analyzers.

Building: go build shortener/cmd/staticlint
Usage: staticlint.exe [-flag] [package]
...
ExitCheckAnalyzer Check for using os.Exit in main() of main package
checknoglobals Check that there are no globalvariables, except for errors and variables containing regular expressions
